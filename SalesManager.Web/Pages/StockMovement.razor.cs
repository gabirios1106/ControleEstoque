...
namespace SalesManager.Web.Pages
{
    public class StockMovementBase : ComponentBase
    {
        ...
        protected void ShowCreatePurchaseModal()
        {
            ...
            DialogService.Show<StockMovementCreatePurchaseDialog>("Reposição de produto", dialogParameters, dialogOptions);
        }
        ...
        protected void ShowCreateSaleModal()
        {
            ...
            DialogService.Show<StockMovementCreateSaleDialog>("Cadastro de venda", dialogParameters, dialogOptions);
        }
    }
}
